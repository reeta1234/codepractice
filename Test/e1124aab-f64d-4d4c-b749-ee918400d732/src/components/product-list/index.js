                                ...
                                <div className="card-actions justify-content-center pa-4">
                                    ...
                                    <div className="layout-row justify-content-between align-items-center">
                                        <button className="x-small icon-only outlined"
                                                data-testid="btn-quantity-subtract" onClick={()=>this.props.updateDecrement(product)} 
                                                disabled={!this.props.decrement}>
                                            <i className="material-icons">remove</i>
                                        </button>

                                        <input type="number"
                                               disabled
                                               className="cart-quantity" data-testid="cart-quantity" value={product.quantity}/>

                                        <button className="x-small icon-only outlined"
                                                data-testid="btn-quantity-add" onClick={()=>this.props.updateIncrement(product)} 
                                                disabled={!this.props.increment}>
